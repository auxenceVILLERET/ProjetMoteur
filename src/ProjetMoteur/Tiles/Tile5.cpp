...
void Tile5::Initialize(ECS* ecs, Renderer* renderer)
{
	...
	CreateTileEntity(ecs, renderer, { 0.0f, 0.0f, 6.0f }, { 0.1f, 2.8f, 0.1f }, 45);
	CreateTileEntity(ecs, renderer, { 2.0f, 0.0f, 8.0f }, { 0.1f, 6.0f, 0.1f }, 0);
	CreateTileEntity(ecs, renderer, { 2.0f, 0.0f, 14.0f }, { 0.1f, 2.0f, 0.1f }, 0);

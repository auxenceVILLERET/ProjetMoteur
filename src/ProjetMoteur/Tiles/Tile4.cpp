...
void Tile4::Initialize(ECS* ecs, Renderer* renderer)
{
	...
	CreateTileEntity(ecs, renderer, { 2.0f, 0.0f, -2.0f }, { 0.1f, 6.0f, 0.1f }, 0);
	CreateTileEntity(ecs, renderer, { 2.0f, 0.0f, 4.0f }, { 0.1f, 2.8f, 0.1f }, 315);
	CreateTileEntity(ecs, renderer, { 0.0f, 0.0f, 6.0f }, { 0.1f, 2.0f, 0.1f }, 0);
	CreateTileEntity(ecs, renderer, { 0.0f, 0.0f, 8.0f }, { 0.1f, 2.8f, 0.1f }, 45);
	CreateTileEntity(ecs, renderer, { 2.0f, 0.0f, 10.0f }, { 0.1f, 6.0f, 0.1f }, 0);
	...
	// Define Walls
	CreateWallEntity(ecs, renderer, { 2.0f, 0.0f, 16.0f }, { 1.0f, 1.0f, 1.0f });

...
void Tile3::Initialize(ECS* ecs, Renderer* renderer)
{
	...
	tileEntity1->AddComponent<MeshRendererComponent>()->SetMesh(RessourceManager::Instance().GetCylinder(), renderer);
	...
	tileEntity1->SetScaleVector({ 0.1f, 1.5f, 0.1f });

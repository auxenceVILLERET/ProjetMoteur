...
bool Texture2D::LoadFromFileWIC(ID3D12Device* device, UploadContext* uploader, DescriptorHeapManager* heap, const wchar_t* filename)
{
    if (device == nullptr || uploader == nullptr) return false;
